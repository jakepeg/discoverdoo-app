...
module.exports = __webpack_require__("DL9u");
...
// CONCATENATED MODULE: ./pages/activity/[id]/edit.js
...
class edit_EditActivity extends external_react_default.a.Component {
  constructor(...args) {
    ...
    edit_defineProperty(this, "HandleUpdateActivity", activity => {
      Object(actions["i" /* updateActivity */])(activity).then(updatedActivity => {
        router_default.a.push('/activity/[id]', `/activity/${activity.id}`);
      });
    });
  }
  ...
  static async getInitialProps({
    ...
    const activity = await Object(actions["g" /* getActivityById */])(query.id);
    return {
      activity
    };
  }
