...
class Callback extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  async componentDidMount() {
    await _services_auth0__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].handleAuthentication(); // this.props.router.push(Cookies.get('returnURL'))

    console.log(js_cookie__WEBPACK_IMPORTED_MODULE_3___default.a.get('returnURL'));
    this.props.router.push(js_cookie__WEBPACK_IMPORTED_MODULE_3___default.a.get('returnURL'));
  }
