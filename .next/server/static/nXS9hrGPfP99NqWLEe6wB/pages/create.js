...
const Create = props => {
  ...
  const submitForm = () => {
    ...
    if (isValid) {
      Object(actions["c" /* createActivity */])(_objectSpread({}, form)).then(() => {
...
const CreatePage = () => create_jsx(external_react_default.a.Fragment, null, create_jsx(head_default.a, null, create_jsx("title", null, "DiscoverDoo - Add an activity"), create_jsx("meta", {
  name: "title",
  content: "DiscoverDoo fun finder"
})), auth0["a" /* default */].isAuthenticated() && create_jsx(create, null), auth0["a" /* default */].isAuthenticated() === false && create_jsx("h1", null, "Please sign in to add activities"));
